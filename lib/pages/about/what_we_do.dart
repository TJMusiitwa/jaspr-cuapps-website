    ...
    return div(classes: 'bg-base-300 py-24 sm:py-32', [
      div(classes: 'mx-auto max-w-7xl px-6 lg:px-8', [
        ...
        div(classes: 'grid grid-cols-1 gap-8 lg:grid-cols-2', [
          ...
          div(
            classes:
                'card flex flex-col bg-white overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300',
            [
              // Image
              ...
              div(classes: 'p-8 sm:p-10 flex-1 flex flex-col', [
                h3(
                  classes: 'text-2xl font-bold tracking-tight text-[#132139]',
                  [Component.text('Mobile App Development')],
                ),
                p(classes: 'mt-4 text-base leading-7 text-[#132139]/70 flex-1', [
                  Component.text(
                ...
                div(classes: 'mt-8 border-t border-[#132139]/10 pt-8', []),
                h4(
                  classes:
                      'text-lg font-semibold leading-8 text-[#132139] mb-4',
...
class _SupportItem extends StatelessComponent {
  ...
  Component build(BuildContext context) {
    return div([
      dt(classes: 'text-sm font-medium leading-6 text-[#132139]/60', [
        Component.text(label),
      ]),
      dd(
        classes:
            'w-full flex-none text-lg font-bold leading-9 tracking-tight text-[#132139]',
