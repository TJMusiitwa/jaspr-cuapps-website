...
class TestimonialsSection extends StatelessComponent {
  ...
  Iterable<Component> build(BuildContext context) sync* {
    yield section([
      div([
        div(classes: 'mx-auto max-w-screen-sm', [
          h2(
              classes:
                  'mb-4 text-4xl tracking-tight font-extrabold sm:text-5xl',
          ...
          ], classes: 'mb-8 font-light text-gray-500 lg:mb-16 sm:text-xl'),
        ]),
        div(
          [
            div(
                    ...
                    div(
                      [
                        svg(
                          ...
                          classes: 'w-20 h-auto sm:w-24 text-gray-700',
                          width: Unit.pixels(140),
                          height: Unit.pixels(47),
                          viewBox: '0 0 140 47',
                          attributes: {
                            'fill': 'none',
                        ...
                        p(
                          ...
                          classes:
                              'mt-3 sm:mt-6 text-base text-gray-800 md:text-xl',
                        ),
                      ],
                      classes: 'flex-auto p-4 md:p-6',
                    ),
                    div(
                      [
                        h3(
                          [
                            text('          Nicole Grazioso        '),
                          ],
                          classes:
                      ...
                      classes: 'p-4 rounded-b-xl md:px-6',
                    ),
                  ],
                  classes:
                      'flex flex-col bg-white border border-gray-200 shadow-sm rounded-xl',
                ),
                div(
                  [
                    div(
          ...
          classes:
              'py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6'),
    ], classes: 'mt-5 py-10 sm:py-16');
  }
