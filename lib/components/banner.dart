...
class Banner extends StatelessComponent {
  final bool chat;
  const Banner({super.key, this.chat = false});

  @override
  Component build(BuildContext context) {
    return div(
      classes:
          'mx-auto w-full px-4 sm:px-6 lg:px-8 text-base-200 ${chat ? 'bg-secondary' : 'bg-primary'}',
      [
        div(
          classes:
          ...
          [
            div(
              ...
              [
                ...
                a(href: 'tel:0141 266 0189', classes: 'text-sm', [
                  Component.text('🇬🇧 0141 266 0189'),
                ]),
                a(href: 'tel:0749707869', classes: 'text-sm', [
                  Component.text('🇮🇪 074 970 7869'),
                ]),
                a(href: 'tel:+13133061560', classes: 'text-sm', [
